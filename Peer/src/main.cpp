...
int main()
{
    ...
    auto a = Utils::FileUtils::readFileToVector("/home/user/Desktop/Maghshimim/Bit Torrent Uri + Nina/Gitabic/Peer/test.gitabic"); // Need to create 300000001 'a' in test.txt
