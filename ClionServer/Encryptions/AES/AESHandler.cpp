...
void AESHandler::decrypt(vector<uint8_t> &data, Matrix4x4 *iv, const bool isPadded)
{
...
uint8_t AESHandler::rcon(const uint8_t round)
{
...
uint8_t AESHandler::sBox(const uint8_t input)
{
...
void AESHandler::subBytes(Matrix4x4 &mat, bool isEnc)
{
    for (size_t i = 0; i < mat.size(); i++)
    {
        ...
        {
            mat[i][j] = isEnc ? sBox(mat[i][j]) : sBoxInv(mat[i][j]); // Use the correct sbox for encryption / decryption
        }
    }
}
