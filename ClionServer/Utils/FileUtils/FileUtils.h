...
namespace Utils
{
    ...
    public:
        ...
        static void createFilePlaceHolder(const std::string &filePath, uint64_t size);
        ...
        static bool verifyPiece(const std::string &filePath, uint64_t offset, uint64_t size, HashResult hash);
    };
